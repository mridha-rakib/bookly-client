...
import { Camera01Icon, User02Icon, Notification01Icon, SecurityCheckIcon } from "@hugeicons/core-free-icons";
...
export default function SupervisorSettings() {
  ...
  // equivalent exists for SUPERVISOR (only CUSTOMER has one — see Batch 17/18), so editing stays
  ...
  // Business role (see customer Batch 17's own equivalent note).
